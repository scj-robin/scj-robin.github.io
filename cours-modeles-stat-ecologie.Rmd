...
*  [Modélisation d'un réseau hôtes/parasites (arbres/champignons)](https://scj-robin.github.io/examples/FungiTreeInteractions-LBM.html) (modèle à blocs latents binaire)
*  [Modélisation d'un réseau plentes/animauxc](https://scj-robin.github.io/examples/PlantAnimals-MultipartiteLBM.html) (modèle à blocs latents binaire)
...
*  [Inférence de réseaux d'interactions directes entre espèces](https://scj-robin.github.io/examples/BarentsPLNnetwork.html) (modèle à Poisson log-normal avec et sans covariable)

#### TD : Sujets et données 

##### TD1 : 

* Sujet : [Régression de Poisson excès de zéros](https://scj-robin.github.io/td/TD1.pdf)
