...
* Sujet 2 : [Analyse d'un déplacement animal par chaîne de Markov cachée](https://scj-robin.github.io/td/TD2.pdf), données : [Déplacement d'un zèbre](https://scj-robin.github.io/td/dryad_zebra.csv), code R partiel :  [TD2.R](https://scj-robin.github.io/td/TD2-partiel.R)
