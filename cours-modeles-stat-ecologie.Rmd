...
Des notes de cours sur l'inférence des modèles à variables latentes sont disponibles [ici](https://scj-robin.github.io/lecture-notes.html), de même que le [support] d'une série de cours doctoraux(https://scj-robin.github.io/lecture-slides.html) sur l'utilisation de certains de ces modèles en écologie.
